...
describe('GET /find_friend', () => {
  ...
  it('should return  find friend page', (done) => {
    supertest(app)
      .get('/find_friend')
      .set('x-access-token', data.accessToken)
...
describe('POST /send_friend_req', () => {
  ...
  it('should send  self uId to friend', async () => {
    const { body } = await supertest(app)
...
describe('POST /accept_friend_req', () => {
  it('should return  bad request', async () => {
    const { body } = await supertest(app)
  ...
  it('should accept frined friend', async () => {
    const { body } = await supertest(app)
  ...
  it('should show friend request not exist', async () => {
    const { body } = await supertest(app)
      .post('/accept_friend_req')
      .set('x-access-token', friendData.accessToken)
      .send({ friendUserId: data.uId })
