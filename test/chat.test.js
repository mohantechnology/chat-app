...
describe('POST /upload_file', () => {
  ...
  it('should Upload given  file', async () => {
    const { body } = await supertest(app)
      .post('/upload_file')
...
describe('GET /list_download_filemessage', () => {
  it('should return  bad request', async () => {
    const { body } = await supertest(app)
  ...
  it('should download given file', async () => {
  ...
  it('should return  not accessible', async () => {
    const { body } = await supertest(app)
      .get('/download_file?fileName=../../../some_file.jpg')
      .set('x-access-token', data.accessToken)
      .expect('Content-Type', /application\/json/)
...
describe('POST /save_message', () => {
  ...
  it("should save message as 'Readed'", async () => {
    messageData.receiver.currentStatus = 'online';
    messageData.receiver.uId = friendData.uId;
  ...
  it("should save message as 'Unreaded'", async () => {
  ...
  it("should save message with file as 'Readed'", async () => {
    messageData.receiver.currentStatus = 'online';
    messageData.receiver.uId = friendData.uId;
  ...
  it("should save message with file as 'Uneaded'", async () => {
    messageData.receiver.currentStatus = 'offline';
    messageData.receiver.uId = friendData.uId;
    messageData.fileName = fileDetail.fileName;
    messageData.mimeType = fileDetail.mimeType;
